...
- 오로지 네트워크 및 기본 인프라 서버를 기반으로 프로젝트를 진행하는 것이 처음이고 팀장으로서 프로젝트를 이끌고 간다는 것이 어색했습니다.
  이전 직장에서 네트워크 설계도를 봤던 기억, 업무를 위해 설계도의 기억을 기반삼아 문서화를 기반삼아 작업을 이어 나갔습니다.
  또한 서버가 제 메인 업무였기에 서버를 함께 담당하는 팀원과 함께 서버들을 계획하고, 구축하며 전반적인 구축에 대한 이해도가 올라 간 것을 느꼈습니다.
  짧은 기간 공부한 내용들을 직접 LACK 구성을 하며 만들어 본 좋은 기회엿습니다.
